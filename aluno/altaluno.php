...
?>
  ...
  <p for=>Nome completo</p>
        <input type="text" name="nomealuno" class="butao" value= "<?php echo htmlspecialchars( $nomealuno)?>" >
        <p for=>Digite sua idade</p>                  
        <input type="text" name="idadealuno" class="butao" value= "  <?php echo htmlspecialchars($idadealuno ) ?> " >
        <p for=>Informe sua data de nascimento</p>
        <input type="text" name="datanascimentoaluno" class="butao" value= " <?php echo htmlspecialchars($datanascimentoaluno)  ?> ">
        <p for=>Digite seu endereço</p>
        <input type="text" name="enderecoaluno" class="butao" value= " <?php echo htmlspecialchars($enderecoaluno) ?> ">
        <p for=>Informe seu status</p>
        <select name="estatusaluno" class="butao" value= " <?php echo htmlspecialchars( $estatusaluno) ?> ">
